...
#include "ExampleFreeTypeFont.hh"
...
ExampleFreeTypeFont::ExampleFreeTypeFont(QWidget *parent)
...
ExampleFreeTypeFont::~ExampleFreeTypeFont()
{
    cleanup();
}

void ExampleFreeTypeFont::animate()
{
    update();
}

void ExampleFreeTypeFont::resizeGL( int width, int height )
{
    // TODO
}

void ExampleFreeTypeFont::initializeGL() {
    ...
    const char* vertexPath = "/Users/eddiehoyle/Code/cpp/game/sevengine-workshop/resources/text.vert";
    const char* fragmentPath = "/Users/eddiehoyle/Code/cpp/game/sevengine-workshop/resources/text.frag";
...
void ExampleFreeTypeFont::paintGL()
{
    // FreeType
    FT_Library ft;
    ...
    // Load font as face
    FT_Face face;
    if (FT_New_Face(ft, "/Library/Fonts/Tahoma.ttf", 0, &face))
    ...
    RenderText( "abcdefghijklmnopqrstuvwxyz", 25.0f, 25.0f, 1.0f, glm::vec3(0.5, 0.8f, 0.2f), VAO, VBO );
    RenderText( "ABCDEFGHIJKLMNOPQRSTUVWXYZ", 100.0f, 100.0f, 0.5f, glm::vec3(0.3, 0.7f, 0.9f), VAO, VBO );
}

void ExampleFreeTypeFont::cleanup()
{
    // TODO
}
